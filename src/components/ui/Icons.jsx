...
export function IconCode({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export function IconSmartphone({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export function IconBrush({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M19 11l-8-8-8 8v8a2 2 0 002 2h12a2 2 0 002-2v-8z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M13 13a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
  );
}

export function IconServer({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export function IconNetwork({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4m0 0H5v4m7-4h7v4" />
    </svg>
  );
}

export function IconWrench({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export function IconCpu({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export function IconGithub({ className = "w-5 h-5", ...props }) {
  return (
...
export function IconLinkedin({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" {...props}>
...
export function IconMoon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export function IconMapPin({ className = "w-4 h-4", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
export function IconGraduationCap({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
